...
! function (a) {
    ...
    b.prototype = {
        ...
        toXamarinString: function () {
            var r = (this._r / 255).toFixed(2),
                g = (this._g / 255).toFixed(2),
                b = (this._b / 255).toFixed(2),
                a = (this._a).toFixed(2);
            return "new UIColor(red: " + r + "f, green: " + g + "f, blue: " + b + "f, alpha: " + a + "f)"
        },
        toHex: function (a) {
        ...
        toName: function () {
            return 0 === this._a ? "transparent" : this._a < 1 ? !1 : U[i(this._r, this._g, this._b, !0)] || "-"
        },
        toFilter: function (a) {
    ...
    var T = b.names = {
            ...
            ndr15: "333333",
            ndr16: "222222",
            NDR_Dachmarkenfarbe: "0d1754",
            NDR_Akzentfarbe_Vollton: "0e57ab",
            NDR_Eilmeldung_Hintergrund: "fcf7b8",
            NDR_Live_Kennzeichnung: "ff6a56",
            NDR_Fehler: "dd1515",
            NDR_Fernsehen_Web_Farbe: "063460",
            NDR_Akzentfarbe_Fernsehen: "00b0de",
            NDR_Invertierter_Text_und_Symbole: "ffffff",
            NDR_Hintergrund_Grau_Boxen_Aufmacher_Live_Formular: "f6f6f6",
            NDR_Hintergrund_Grau_Navigation_Formularunterstrich: "eeeeee",
            NDR_Linien: "e2e2e2",
            NDR_Hintergrund_Grau: "d6d6d6",
            NDR_Platzhaltertext: "888888",
            NDR_Textfarbe_Minimalkontrast_valide_Lesbarkeit: "555555",
            NDR_Textfarbe_Dunkelgrau: "333333",
            NDR_Dunkler_Hintergrund_Bildergalerie: "222222"
        },
        U = b.hexNames = y(T),
        V = function () {
            var a = "[-\\+]?\\d+%?",
